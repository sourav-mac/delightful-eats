...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-dvh overflow-hidden flex bg-muted/30">
      {/* Sidebar - Fixed position with full dynamic viewport height */}
      <aside 
        className={cn(
          "fixed top-0 left-0 h-dvh bg-card border-r border-border z-50 flex flex-col overflow-hidden",
      ...
      >
        ...
        {/* Logout Button - Sticky at bottom, always visible */}
        <div className="shrink-0 sticky bottom-0 p-2 border-t border-border bg-card pb-[env(safe-area-inset-bottom)]">
          <button
      ...
      <main className={cn(
        "flex-1 h-dvh overflow-y-auto transition-[margin] duration-300 ease-in-out",
